 ...
 *
 * MUST be registered before GET /:key{.+} below — that wildcard route would
 * otherwise swallow /streetview/:id (matching it as key="streetview/...")
 * and 404 before this handler ever runs. Same class of bug as the CSV
 * export route shadowing fixed earlier this session.
 */
